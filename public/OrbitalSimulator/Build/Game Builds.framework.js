...
var ASM_CONSTS = {
  5198636: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5198691: ($0) => { performance.now = function() { return $0; }; },  
 5198739: ($0) => { performance.now = function() { return $0; }; },  
 5198787: () => { performance.now = Module['emscripten_get_now_backup']; }
};
